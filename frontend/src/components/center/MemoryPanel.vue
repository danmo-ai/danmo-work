...
async function load() {
  ...
  try {
    ...
    items.value = []
    // Soft-fail 404: panel stays mounted (v-show) and reloads on every
    // session/agent/project change — an outdated sidecar without /memories
    // must not spam "404 page not found" toasts on routine clicks.
