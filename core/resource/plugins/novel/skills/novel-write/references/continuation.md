...
给出 **3 条可执行路线**（换钩、降维、回收伏笔、插支线等），`ask_user` 选一条。优先对照下方「卡文四法」。

## 卡文四法（剧情流卡死时）

在已有总纲/卷纲/章纲前提下仍写不动时，按序尝试（**禁止水文凑字**）：

1. **复盘大纲与章纲** — 拉总纲/卷纲单元卡 + 本章及邻章纲，查漏补缺；细排 beats 常能理出下一拍。
2. **加快进度、精简情节** — 主动跳出卡死的故事区域；越卡越要砍冗余，禁止无关痛痒注水。
3. **换地图 / 换支线** — 给主角新场景或抬高矛盾（复仇后逃亡、新对手入场）。
4. **拆配角线 / 未解伏笔** — 从配角独立目标或已埋包袱续写，丰满主线。

无大纲导致的卡文：先回 `novel-plan` 补单元卡，再写章纲；下一本勿裸写。情绪/身体耗尽：允许休息 1–2 天再写，勿硬注水。灵感枯竭：翻立项素材或短开头积累（见 KB 节奏矛盾链 / 人设动机链）。
