...
name: novel-write
source: builtin
description: Chapter loop for a planned novel. Use for 章合同, batch freeze, drafting or continuing chapters, 字数不足扩写, and Frozen_Canon continuation. Not for book-level outline or final review/Commit.
license: MIT
...
写第 N 章 / 章合同 / 批次冻结 / 续写 / 接手 / 爽点强化 / 字数不足扩写.
