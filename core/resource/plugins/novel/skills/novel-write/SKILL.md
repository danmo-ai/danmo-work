...
name: novel-write
source: builtin
description: Unit outline and first-draft prose only. Use for 单元细纲, drafting one unit file (chapters separated by ---), and Frozen_Canon continuation. Not for 扩写, deslop, review, or Continuity Commit — those are novel-review (separate turn / model).
license: MIT
...
|--------|------|-----------------|
| 单元细纲 | `unit-outline.md` | 节奏与结构（新名用文内取名短清单） |
