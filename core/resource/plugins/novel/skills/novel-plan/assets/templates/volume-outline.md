...
- [ ] 单元规模在 `unit_scale` 范围内（默认 3–8 章/单元，硬上限 10 章）
...
每个单元一行索引。**单元级合同**（desire/obstacle/choice/payoff/pleasure/forbidden/scenes/chapters）只写在 `outline/units/v{{NN}}-U#.yaml`，本文件不重复。
