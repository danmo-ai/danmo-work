...
func (h *ExecShell) Schema() domain.ToolSchema {
	return domain.ToolSchema{
		...
		Description: "Execute a shell command and return its stdout/stderr. HIGH RISK — requires user approval.\n\n" +
			...
			"- Do NOT use for reading/writing files — use read_file, write, edit, edit_batch, or apply_patch instead.\n" +
			"- Do NOT use for moving/copying/deleting files — use file_op instead.\n" +
