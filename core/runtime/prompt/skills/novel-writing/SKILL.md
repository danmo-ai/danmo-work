...
2. **Pipeline:** chapter contract → draft → one review round → Commit. `qc_gate` FAIL blocks「定稿」.
...
| Outline / 卷纲章纲 | `references/outline.md` | 节奏与结构 |
| Chapter contract | `references/chapter-contract.md` | 节奏, 爽点 |
